    ...
    <>
      <div className="hero-container bg-white py-16 px-4 md:px-20 grid grid-cols-1 md:grid-cols-2 items-center gap-8"
        ...
        <div className="hero-content space-y-6 text-center">
          <h1 className="hero-title text-5xl md:text-5xl font-bold text-black" style={{ color: primaryText }}>
            FIND OUT-FITS THAT
            <br /> MATCHES YOUR
            <br /> STYLES
          </h1>
          ...
          <button className="hero-button bg-black text-white py-4 px-14 rounded-full hover:bg-black/80 cursor-pointer transition duration-300" style={{ backgroundColor: primaryText, color: primaryBg }}>
            Shop Now
          </button>
        ...
        <div className="h-full flex items-center justify-center">
          <img
            src={heroImage}
            alt="Hero"
            className="w-[350px] object-cover rounded-2xl shadow-xl"
          />
        </div>
      </div>
      <div className="py-8 px-4 md:px-20 flex items-center justify-center top-0" style={{ backgroundColor: primaryText, color: primaryBg }}>
