...
const Footer = () => {
  return (
    <footer className=" Footer-Container bg-gray-200 mt-10">
      {/* Newsletter Section */}
      <div
        className="w-full bg-white"
        style={{
          background:
            "linear-gradient(0deg,rgba(229, 231, 235, 1) 50%,rgba(255, 255, 255, 1) 0%)",
        }}
      >
        <div className="bg-black flex gap-5 text-white py-6 px-6 mx-auto rounded-xl lg:w-[70%]">
      ...
      <div className="px-6 md:px-20 py-12 text-black grid gap-10 md:grid-cols-5">
        ...
        <div className="col-span-1">
          <h1 className="text-2xl font-bold mb-3 hover:cursor-pointer">
            STALLION WEAR
          </h1>
